# zPermissions &mdash; A Superperms plugin for Bukkit [![Build Status](https://travis-ci.com/mirolm/zPermissions.svg?branch=master)](https://travis-ci.com/mirolm/zPermissions)
